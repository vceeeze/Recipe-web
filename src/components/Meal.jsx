...
const Meal = () => {
  ...
  return (
    <div className="max-w-[1520px] m-auto px-2">
      ...
      <div className="flex flex-col lg:flex-row justify-center">
        <div className="flex justify-center md:justify-center">
          <button
            ...
            className="m-1 border-orange-700 text-white bg-orange-700 hover:text-orange-700 hover:bg-white hover:border-orange-700"
          >
            All
          </button>
          <button
