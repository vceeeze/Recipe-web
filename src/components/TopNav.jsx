...
const TopNav = () => {
  ...
  return (
    <div className="max-w-[1520px] mx-auto flex justify-between items-center p-4">
      ...
      <button className="bg-orange-700 text-white hidden md:flex items-center py-2">
      ...
      >
        ...
        <h2 className="text-2xl p-4">
          Vcee<span className="text-orange-700 font-bold">Eat</span>
        </h2>
        <nav>
          <ul className="flex flex-col p-4 text-gray-900">
            <li className="text-xl py-4  flex">
              <BsPerson
                size={25}
                className="rounded-full mr-4 bg-black text-white"
              />
              My Account
            </li>
            <li className="text-xl py-4  flex">
